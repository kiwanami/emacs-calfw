...
(defvar cfw:org-todo-keywords-regexp nil)
...
(defun cfw:org-onclick ()
  ...
  (let ((marker (get-text-property (point) 'org-marker))
        ...
        (_loc    (get-text-property (point) 'cfw:org-loc)))
    (when link
...
from the org schedule data."
  (cl-loop with cfw:org-todo-keywords-regexp = (regexp-opt org-todo-keywords-for-agenda) ; dynamic bind
